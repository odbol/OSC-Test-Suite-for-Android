...
You can use the example to write your own hooks for OSC messages in your app.
...
Bluetooth, such as DrumPants ( http://drumpants.com ) or the VJacket ( http://vjacket.com ). This
